                ...
                <div className="flex flex-col-reverse lg:flex-row items-center justify-between gap-6 md:gap-12 lg:gap-16">
                    <div className="flex-1 space-y-6 text-center lg:text-left">
                        ...
                        <div className="w-full max-w-2xl mx-auto lg:mx-0">
                            <span className="user-name text-3xl md:text-5xl lg:text-8xl font-bold text-gray-900 dark:text-white opacity-100" >Hello, I'm Abhishek Kumar Ray</span>
                        </div>
                        <p className="mt-5 md:mt-6 mb-4 md:mb-6 pb-6 text-lg sm:text-xl text-gray-600 dark:text-gray-300 max-w-2xl leading-relaxed">
                            IN From India | IT Specialist & Full-Stack Developer | Pragmatic, delivery-oriented | Always growing, one step at a time
                        </p>
                        ...
                        <div className="flex items-center space-x-4 md:space-x-12 mt-6 md:mt-12">
                            <a href="" className="p-[3px] relative">
                                ...
                                <div className="px-2 md:px-8 py-4  bg-black rounded-full relative group transition duration-200 text-white hover:bg-transparent">Download CV <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-download inline-block ml-2 mb-1 w-4 h-4 hover:animate-bounce" aria-hidden="true"><path d="M12 15V3"></path><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path><path d="m7 10 5 5 5-5"></path></svg></div>
                            </a>
                        ...
                        <div className="mt-6 pt-7 md:mt-14 flex flex-wrap justify-center gap-4 lg:gap-16">
                            <div className="flex items-center space-x-4">
                                ...
                                <span className="text-sm md:text-lg text-gray-600 dark:text-gray-400">Age</span>
                            </div>
                            <div className="flex items-center space-x-4">
                                <span className="text-2xl md:text-5xl font-bold text-gray-900 dark:text-white opacity-100 transform-none">
                                    <span></span>
                                ...
                                <span className="text-sm md:text-lg text-gray-600 dark:text-gray-400">MOE</span>
                            </div>
                            <div className="flex items-center space-x-4">
                                <span className="text-2xl md:text-5xl font-bold text-gray-900 dark:text-white opacity-100 transform-none">
                                    <span></span>
                                ...
                                <span className="text-sm md:text-lg text-gray-600 dark:text-gray-400">Projects Completed</span>
                            </div>
                        </div>
                    </div>
                    <div className="opacity: 1; transform: none;">
                        <div className="flex-shrink-0 relative">
                            <div className="relative w-[350px] h-[350px] md:w-[480px] md:h-[480px] rounded-full overflow-visible">
                                ...
                                >
                                    <div
                                        className="w-80 h-80 md:w-[450px] md:h-[450px] rounded-full overflow-hidden relative"
                                        style={{
                                            background: "linear-gradient(45deg, rgb(6, 182, 212), rgb(236, 72, 153), rgb(16, 185, 129), rgb(245, 158, 11))",
                                            padding: "5px",
                                            boxShadow:
